...
lst = {
    ...
    "IMGUI_SETCOLUMN_WIDTH" : 0x2251,
    "IMGUI_BEGIN_CHILDEX" : 0x2252,
    "IMGUI_BEGIN_DISABLED" : 0x2253,
    "IMGUI_END_DISABLED" : 0x2254,
    "IMGUI_BEGIN_MENU" : 0x2255,
    "IMGUI_END_MENU" : 0x2256,
    "IMGUI_SET_CUSTOM_FONT_ENABLED" : 0x2257,
    "IMGUI_IS_CUSTOM_FONT_ENABLED" : 0x2258,
    "IMGUI_LOAD_CUSTOM_FONT" : 0x2259
}
